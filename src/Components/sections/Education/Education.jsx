    ...
    >
      ...
      <div className={`lg:w-1/3 flex justify-center ${isEven ? "lg:justify-end" : "lg:justify-start"}`}>
        <motion.div
          ...
          className={`relative w-32 h-32 lg:w-40 lg:h-40 rounded-2xl flex items-center justify-center border bg-white/5 backdrop-blur-sm overflow-hidden flex-shrink-0 ${item.current
      ...
      <div className="hidden lg:flex absolute left-1/2 -translate-x-1/2 z-10 items-center justify-center">
        <motion.div
          ...
          whileInView={{ scale: 1 }}
          viewport={{ once: true }}
          transition={{ delay: index * 0.15 + 0.35, type: "spring", stiffness: 260, damping: 20 }}
          className={`relative w-5 h-5 rounded-full border-2 ${item.current
              ? "bg-red-600 border-red-400 shadow-[0_0_18px_rgba(239,68,68,0.7)]"
      ...
      <div className="w-full lg:w-2/3">
        <TiltCard>
          ...
          >
            ...
            {/* Left accent bar */}
            <div
              className={`absolute left-0 top-0 bottom-0 w-1 rounded-l-2xl ${item.current
            ...
            <div className="p-6 md:p-8 pl-7 md:pl-9" style={{ transform: "translateZ(18px)" }}>
              ...
              <div className="flex items-start gap-4 mb-4 pr-28">
                <div
                  className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-lg border mt-0.5 ${item.current
